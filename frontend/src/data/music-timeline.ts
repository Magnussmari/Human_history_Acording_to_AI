 ...
 * Generated by a 7-agent parallel swarm on 2026-07-15, then enriched with
 * region + certainty by a second swarm. Layer 2 (Scite scholarly evidence,
 * with real sources) enrichment is prepped in the classical-music-opera-
 * timeline/research-mission folder. Dates marked "c." are approximate;
 * "certainty" uses the ICCRA vocabulary (confirmed / probable / approximate /
 * traditional / legendary) and reflects historical confidence, not sources.
 */
